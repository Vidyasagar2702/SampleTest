...
public class Constants {
    ...
    public static final String idpass = "Passwd";
    
    public static final String idsearch = "gbqfq";
    
    public static final String idsearchenter = "gbqfbw";
    
    public static final String idsign= "signIn";
